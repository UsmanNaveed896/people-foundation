    ...
    >
      <div className="flex items-center justify-center">
        <div className="container max-w-[1400px] px-12">
          <h1 className="md:text-[70px] text-[35px] font-extrabold leading-[50px] md:leading-[80px] text-white ">
            {" "}
...
{/* CARD1 */}
          <div className="relative z-[9999]">
            <div className="flex md:flex-row flex-col md:gap-0 gap-1 justify-center mb-[-204px] ">
              <div className="py-6 px-6 bg-gradient-to-b from-[#313DAA] to-transparent to-[120%] font-poppins max-w-[330px] flex justify-between flex-col">
              ...
              <div className="py-6 px-4 bg-[linear-gradient(180deg,#3743AC_9.69%,rgba(255,0,4,0.52)_121.37%)] font-poppins max-w-[330px] flex justify-between flex-col">
                <h1 className="mt-3 text-white font-semibold text-[20px]">
                  {" "}
                  Become a Volunteer{" "}
                </h1>
