...
const Mentoring = () => {
  return (
    <div
      ...
      className="bg-cover bg-center font-poppins relative py-2"
    >
      <div className="grid md:grid-cols-12 grid-cols-1 items-center">
        <div className="col-span-6  mt-12 ">
          <div className=" flex justify-center">
            <div>
              <img className=" h-[250px] md:h-[400px] mt-0 ml-16" src={Img1} alt="abc" />
              <img
          ...
          <div className="flex justify-start md:pl-12 px-4">
            <div>
              ...
              <h1 className="font-poppins font-extrabold text-[24px] text-[#303CA9] text-center md:text-start">
                Simply put, there is no substitute for <br className="hidden md:block"/> building a solid
                foundation through  <br className="hidden md:block"/> developing a relationship with  <br className="hidden md:block"/>
                Counselor(s)/Mentors
              </h1>
              <div className=" mt-6">
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li className="relative">
                    <span className="absolute -left-[20px] top-2 h-2 w-2 bg-red-500 rounded-full"></span>
                    The success rate of mentored small businesses compared to those without a mentor is stunning: 76%+ of mentored businesses survive past the initial 5 years.
                  </li>
                </ul>
