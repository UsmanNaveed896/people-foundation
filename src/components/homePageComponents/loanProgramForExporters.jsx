  ...
  return (
    <>
            ...
            <div className="flex justify-center">
              <div>
                ...
                <div className="grid md:grid-cols-3 grid-cols-1 px-12 gap-12  mt-16">
                  ...
                  ✅ International Trade Loan – used to significantly expand <br className="hidden md:block"/> an existing export market or develop new export markets
                  </div>
                  <div className="rounded-tl-2xl rounded-br-xl md:py-4 py-9 px-12 bg-[#FF0606] text-white font-bold text-[15px] md:text-start  text-center">
                  ✅  Used to upgrade facilities or equipment that will <br  className="hidden md:block"/>  improve the company’s competitive position
                  </div>
                  <div className="rounded-tl-2xl rounded-br-xl md:py-4 py-9 px-12 bg-[#FF0606] text-white font-bold text-[15px] md:text-start  text-center">
      ...
      <div
        ...
        className="bg-cover bg-center font-poppins relative md:py-32 py-16"
      >
          ...
          <div className="second-column pr-4 col-span-6 py-16">
            <div className="flex justify-start pl-12">
              <div>
                ...
                <h1 className="font-poppins font-extrabold text-[24px] text-[#fff]">
                  Capital - SBA LOAN PROGRAMS for Exporters
                </h1>
                <div className=" mt-6">
                  <ul className=" pl-1 space-y-2 text-white">
                    <li className="relative">
                      <span className=""></span>✅ Can be single transaction or
                      multiple sales on a revolving line of credit
                    </li>
                    <li className="relative">
      ...
      >
        <div className="grid md:grid-cols-12 grid-cols-1 items-center">
            ...
            <div className="flex justify-start md:pl-12 px-4 md:px-0">
              <div>
                ...
                <div className=" mt-6">
                  <ul className=" pl-1 space-y-2 text-white">
                    <li className="relative">
                      <span className=""></span>✅ International Trade Loan –
                      used to significantly expand an existing export market or
          ...
          <div className="col-span-6  mt-12 ">
            <div className=" flex justify-center">
              <div>
                <img className="h-[400px] mt-0 md:ml-16" src={Img4} alt="abc" />
                <img
