...
const OurPartners = () => {
  return (
    <div
      ...
      className="bg-cover bg-center font-poppins relative"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 pb-16 md:pb-32 ">
        <div className="second-column px-4 md:pr-4 md:col-span-7">
          <div className="flex justify-center md:pl-12">
            <div>
              <h1 className="font-poppins text-white text-center md:text-left">
                OUR PARTNERSHIP IS OUR STRENGTH
              </h1>
              <h1 className="font-poppins font-extrabold text-[20px] md:text-[24px] text-white text-center md:text-left">
                Together, We Grow <br className="hidden md:block" /> Stronger
              </h1>
              <p className="text-[#fff] mt-4 text-center md:text-left">
              ...
              <p className="text-[#fff] mt-3 text-center md:text-left">
              ...
              <button className="mt-4 bg-white text-[#FF0606] px-6 py-2 rounded-full transition-colors block mx-auto md:mx-0">
                Discover
              </button>
            </div>
          </div>
        ...
        <div className="col-span-5 flex justify-center mt-8 md:mt-0">
          <div className="relative z-50">
            ...
            <img className="h-[250px] md:h-[400px]" src={Img2} alt="abc" />
