  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-12 grid-cols-1 items-center">
        ...
        <div className="second-column pr-4 col-span-6 py-16">
          <div className="flex justify-start md:pl-12 px-4 md:px-0">
            <div>
              <h1 className="font-poppins text-[#FF0606] font-normal">
                U.S. Small Business Administration
              </h1>
              <h1 className="font-poppins font-extrabold text-[24px] text-[#FF0606]">
              ...
              <div className="rounded-tl-2xl w-[320px] rounded-br-xl py-2 px-12 bg-header-gradient  text-white font-bold mt-4">
              ...
              <div className="flex gap-16 mt-6">
                <ul className="list-disc pl-5 space-y-2 text-white">
                  ...
                  <li className="relative">
                    <span className="absolute -left-[18px] top-2 h-2 w-2 bg-red-500 rounded-full"></span>
                    ✅ Economic injury assistance is available regardless of{" "}
                    <br /> whether the business suffered any property damage
                  </li>
      ...
      <div className="relative">
            <img className="absolute bottom-[-544px] right-0 z-[-1]" src={Img3} alt="abc" />
        </div>
    </div>
  );
};
