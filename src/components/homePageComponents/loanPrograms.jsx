...
const LoanPrograms = () => {
  return (
    <div
      ...
      className="bg-cover bg-center font-poppins relative md:py-16 py-2"
    >
        ...
        <div className="second-column pr-4 col-span-6 py-16">
          <div className="flex justify-start pl-12">
            <div>
              ...
              <h1 className="font-poppins font-extrabold text-[24px] text-[#303CA9]">
                The SBA has several Loan Programs to <br /> help small
                businesses.
              </h1>
              <div className=" mt-6">
                <ul className="list-disc pl-5 space-y-2 text-white">
                  ...
                  <li className="relative">
                    ...
                    have made the loans to the small business when <br/> applying
                    their own standards.
                  </li>
                  <li className="relative">
                    <span className="absolute -left-[20px] top-2 h-2 w-2 bg-[#303CA9] rounded-full"></span>
