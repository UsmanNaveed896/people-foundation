    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-16 px-4 md:px-8">
        ...
        <div className="md:col-span-12 lg:col-span-5 order-1 md:order-2 pr-0 md:pr-4 mt-[100px] md:mt-0">
          <h1 className="font-poppins font-extrabold text-[18px] sm:text-[20px] md:text-[24px] text-center md:text-left">
            REPRESENTING HOPE, INTEGRITY <br className="hidden md:block"></br>& CREDIBILITY
          </h1>
          <p className="text-[#727272] pr-0 lg:pr-6 mt-4 text-sm md:text-base text-center md:text-left">
          ...
          <p className="text-[#727272] mt-3 pr-0 lg:pr-6 text-sm md:text-base text-center md:text-left">
