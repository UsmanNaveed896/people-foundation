  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center">
        <div className="text-center">
          ...
          <h1 className="font-poppins font-normal text-[14px] md:text-[18px] text-[#fff] mt-4 md:mt-6">
            ...
            <br className="hidden md:block" /> an extensive network of field
            offices and partnerships with public <br className="hidden md:block" />{" "}
      ...
      <div className="flex justify-center mt-8 md:mt-16">
        <div className="rounded-full py-2 px-4 md:py-4 md:px-6 text-[#FF0606] border-[#FF0606] bg-white text-center text-xs md:text-sm">
          The SBA and our resource partners focus on America's small businesses
          as they are:
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-center mt-8 md:mt-12 px-4">
        {/* Card 1 */}
        <div className="rounded bg-white w-full md:max-w-[200px] h-auto md:h-[260px]">
          <img className="h-[150px] md:h-[200px] w-full object-cover" src={Img3} alt="" />
        ...
        {/* Card 2 */}
        <div className="rounded bg-white w-full md:max-w-[200px] h-auto md:h-[260px]">
          <img className="h-[150px] md:h-[200px] w-full object-cover" src={Img4} alt="" />
          <p className="text-red-500 py-2 px-2 text-xs md:text-sm">
        ...
        {/* Card 3 */}
        <div className="rounded bg-white w-full md:max-w-[200px] h-auto md:h-[260px]">
          <img className="h-[150px] md:h-[200px] w-full object-cover" src={Img5} alt="" />
          <p className="text-red-500 py-2 px-2 text-xs md:text-sm">
