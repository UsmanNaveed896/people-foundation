...
const CrimePrevention = () => {
  return (
    <div
      ...
      className="bg-cover bg-center font-poppins relative py-8 md:py-16"
    >
          ...
          <div className="flex justify-start pl-4 md:pl-12">
            <div>
              ...
              <p className="pr-2 md:pr-6 mt-4 text-white text-sm md:text-base">
                ...
                mistrust, we must educate communities through outreach,
                educating practitioners and the public, enhancing victim
                reporting tools, and investigating and prosecuting hate crimes
                committed on the basis of a victim's perceived or actual race,
                color, religion, national origin, sexual orientation, gender,
                gender identity, or disability. Program areas, including
                addressing...
              </p>
