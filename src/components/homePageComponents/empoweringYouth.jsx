          ...
          <div className="flex justify-start pl-4 md:pl-12">
            <div>
              ...
              <p className="pr-2 md:pr-6 mt-4 text-white text-sm md:text-base">
                These young people will pursue their education, prepare for
                future careers, and grow into community leaders building
                brighter futures for themselves and their neighborhoods. We
                will build the skillsets and mindsets that lead to lifelong
                learning, livelihood, and leadership. Our vision is to strive to
                create a world where all young people are seen for their
                potential and power to transform themselves and their
                communities.
              </p>
